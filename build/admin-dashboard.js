...
const dashboardInfo = info => {
  ...
  return {
    ...
    changelogs: [{
      ...
      type: 'new',
      list: ['The free plugin now supports shortcodes.']
    }, {
      version: '2.0.8 - 22 Jan, 2026',
      type: 'update',
      list: ['There were some minor issues with the title and the query, but I have resolved them.']
    }, {
      version: '2.0.7 - 18 Jan, 2026',
      type: 'update',
      list: ['Patchstack ( Cross Site Scripting) problem solved;']
    }, {
      version: '2.0.3 - 18 Sept, 2025',
      type: 'update',
      list: ['Solved the image max-width and margin;']
    }, {
      version: '2.0.2 - 23 Aug, 2025',
      type: 'update',
      list: ['Resolved the conflict between Modula Image Gallery and bSlider;']
    }, {
      version: '2.0.1 - 12 Aug, 2025',
      type: 'update',
      list: ['Resolved all security vulnerabilities identified by Wordfence;']
    }, {
...
document.addEventListener('DOMContentLoaded', () => {
  const dashboardEl = document.getElementById('bsbDashboard');
  const info = JSON.parse(dashboardEl.dataset.info);
  (0,react_dom__WEBPACK_IMPORTED_MODULE_1__.createRoot)(dashboardEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_App__WEBPACK_IMPORTED_MODULE_3__["default"], {
